package org.apache.hadoop.yarn.hpps;
import java.io.File;
...
public class Client {
    ...
    private Map<String, LocalResource> setupCacheFiles(ApplicationId appId) throws IOException {
        // create temporary hpps directory
        ...
        tmpPath = new Path(tmpPath + "/temp-hpps-yarn-" + appId);
        if (dfs.exists(tmpPath)) {
    ...
    private void run(String[] args) throws Exception {
        ...
        String cmd = Environment.JAVA_HOME.$$() + "/bin/java"
                + " -Xmx900m"
                + " org.apache.hadoop.yarn.hpps.ApplicationMaster"
